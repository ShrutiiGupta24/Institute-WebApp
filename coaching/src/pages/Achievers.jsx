            ...
            >
              ...
              {(() => {
                const subjects = Array.isArray(student.subjects)
                  ...
                  ? student.subject
                  : null;
                const scores = Array.isArray(student.score) ? student.score : null;
                ...
                return (
                  <>
                    <p style={{ margin: 0, fontSize: "0.95rem", color: "#374151" }}>
                      <strong>{Array.isArray(subjects) ? "Subjects" : "Subject"}:</strong>{" "}
                      {Array.isArray(subjects) ? subjects.join(", ") : student.subject}
                    </p>
